<Sysmon schemaversion="4.90">
  ...
  <EventFiltering>
    ...
    <ProcessCreate onmatch="include">
      <Image condition="end with">HD-Player.exe</Image>
    </ProcessCreate>
    ...
    <ProcessAccess onmatch="exclude">
      <SourceImage condition="end with">HD-Player.exe</SourceImage>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    ...
    <RuleGroup name="High-Risk Process Access" groupRelation="or">
      ...
      <ProcessAccess onmatch="include">
        <CallTrace condition="contains">NtWriteVirtualMemory</CallTrace>
      </ProcessAccess>
      <ProcessAccess onmatch="include">
    ...
    <RuleGroup name="Memory Tampering" groupRelation="or">
      <ProcessAccess onmatch="include">
        <CallTrace condition="contains">NtWriteVirtualMemory</CallTrace>
    ...
    <RuleGroup name="" groupRelation="or">
      <ProcessAccess onmatch="include">
        <TargetImage condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains">NtProtectVirtualMemory</CallTrace>
      </ProcessAccess>
    </RuleGroup>
    ...
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">ReadProcessMemory</CallTrace>
    </ProcessAccess>

    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtOpenProcess</CallTrace>
    ...
    <ProcessAccess onmatch="include">
      ...
      <CallTrace condition="contains">EtwEventWrite</CallTrace>
    </ProcessAccess>


    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtCreateSection</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtCreateSection</CallTrace>
      <TargetImage condition="end with">Bluestacks.exe</TargetImage>
    </ProcessAccess>
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtMapViewOfSection</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtMapViewOfSection</CallTrace>
    ...
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtCreateThreadEx</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtQueueApcThread</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtAllocateVirtualMemory</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    ...
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtResumeThread</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtSuspendThread</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
   
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">syscall</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    ...
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">LdrLoadDll</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtCreateFile</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
   
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">wow64cpu.dll</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">X64Call</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    

    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">NtUnmapViewOfSection</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    
   
    <ProcessAccess onmatch="include">
      <CallTrace condition="contains">SetWindowsHookEx</CallTrace>
      <TargetImage condition="end with">HD-Player.exe</TargetImage>
    </ProcessAccess>
    ...
    <ProcessAccess onmatch="include">
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">NtUserCallOneParam</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">NtUserCallTwoParam</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">KiSystemCall64</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">KiFastSystemCall</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">KeServiceDescriptorTable</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>

     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">NtProtectVirtualMemory</CallTrace>
       <CallTrace condition="contains">PAGE_EXECUTE_READWRITE</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">LdrGetProcedureAddress</CallTrace>
       <CallTrace condition="contains">ntdll.dll</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains all">kernel32.dll;VirtualProtect</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains all">kernel32.dll;WriteProcessMemory</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">DeviceIoControl</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtDeviceIoControlFile</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">ZwDeviceIoControlFile</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <TargetImage name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="end with">Sysmon.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <TargetImage name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="end with">Sysmon64.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtQuerySystemInformation</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtQueryInformationProcess</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtReadVirtualMemory</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtWriteVirtualMemory</CallTrace>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">NtReadFile</CallTrace>
       <CallTrace condition="contains">.dll</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       ...
       <CallTrace condition="contains">CreateThread</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     

     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">GetThreadContext</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">ZwAllocateVirtualMemory</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">ZwWriteVirtualMemory</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">ZwMapViewOfSection</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">LdrGetDllHandle</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">ZwUnmapViewOfSection</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">VirtualProtectEx</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">NtSystemDebugControl</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>

     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">NtSetInformationThread</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
       <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
     </ProcessAccess>
     ...
     <ProcessAccess onmatch="include">
       <CallTrace condition="contains">VirtualProtect</CallTrace>
       <CallTrace condition="contains">PAGE_EXECUTE_READ</CallTrace>
       <TargetImage condition="end with">HD-Player.exe</TargetImage>
     </ProcessAccess>
    ...
    <ProcessTampering onmatch="include">
      <Image condition="contains">RWX</Image>
      <Type condition="is">ImageTampering</Type>
    </ProcessTampering>


    <ProcessTampering onmatch="include">
      <Image condition="contains">ntdll.dll</Image>
      <Type condition="is">RemoteImageHijack</Type>
    </ProcessTampering>

    <FileDelete onmatch="include">
      <TargetFilename condition="contains">.evtx</TargetFilename>
      

      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\version.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\dwmapi.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\uxtheme.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\winmm.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\wtsapi32.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\wininet.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\msvcr100.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\msvcr110.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\msvcr120.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\msvcp100.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\msvcp110.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\system32\msvcp120.dll</TargetFilename>
      

      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\AppData\</TargetFilename>
      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\ProgramData\</TargetFilename>
      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\Temp\</TargetFilename>
      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\Public\</TargetFilename>
      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\Downloads\</TargetFilename>
      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\Documents\</TargetFilename>
      

      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\amsi.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\dbghelp.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\dbgcore.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\ntdll.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\kernel32.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\kernelbase.dll</TargetFilename>
      

      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\Windows\System32\</TargetFilename>
      <TargetFilename name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">.dll;\Windows\SysWOW64\</TargetFilename>
    </FileDelete>
    ...
    <FileCreate onmatch="include">
      ...
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">.dll;\AppData\</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">.dll;\ProgramData\</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">.dll;\Temp\</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">.dll;\Public\</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">.dll;\Downloads\</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">.dll;\Documents\</TargetFilename>
      

      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\version.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\dwmapi.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\uxtheme.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\winmm.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\wtsapi32.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\wininet.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\amsi.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\dbghelp.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\dbgcore.dll</TargetFilename>

      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\msvcr100.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\msvcr110.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\msvcr120.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\msvcp100.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\msvcp110.dll</TargetFilename>
      <TargetFilename name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\msvcp120.dll</TargetFilename>
    ...
    <RegistryEvent onmatch="include">
      <TargetObject condition="begin with">HKCU\Software\Classes\CLSID\</TargetObject>
      <TargetObject condition="contains all">HKCU\Software\Classes\CLSID;InprocServer32</TargetObject>
      <TargetObject condition="contains all">HKCU\Software\Classes\CLSID;TreatAs</TargetObject>
      <TargetObject condition="contains all">HKCR\CLSID;InprocServer32</TargetObject>
      <TargetObject condition="contains all">HKCR\CLSID;TreatAs</TargetObject>
      ...
      <TargetObject condition="begin with">HKCR\exefile\shell\open\command</TargetObject>
      ...
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows NT\CurrentVersion\Windows</TargetObject>
      ...
      <TargetObject condition="begin with">HKLM\SOFTWARE\Microsoft\Wbem\</TargetObject>

      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Policies\System\Scripts</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Policies\Microsoft\Windows\System\Scripts</TargetObject>

      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer\ShellExecuteHooks</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer\Browser Helper Objects</TargetObject>

      <TargetObject condition="contains all">HKLM\SYSTEM\CurrentControlSet\Control\Print\Environments;Print Processors</TargetObject>

      <TargetObject condition="begin with">HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Installer\</TargetObject>

      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Shell Folders</TargetObject>

      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Services\W32Time\TimeProviders</TargetObject>
      ...
      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Services\bam\State</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\CompatibilityAssistant\Store</TargetObject>
      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\AppCompatCache</TargetObject>

      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\ShellNoRoam\MUICache</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\Shell\MUICache</TargetObject>
      <TargetObject condition="contains all">HKU\S-1-5-21-;Software\Microsoft\Windows\Shell\MUICache</TargetObject>

      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\ComDlg32\OpenSavePidlMRU</TargetObject>

      <TargetObject condition="begin with">HKCU\Software\Classes\Local Settings\Software\Microsoft\Windows\Shell\Bags</TargetObject>
      <TargetObject condition="begin with">HKCR\ms-settings\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\mscfile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows NT\CurrentVersion\Winlogon\Notify</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows NT\CurrentVersion\Winlogon\Notify</TargetObject>
      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs</TargetObject>
      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\ExcludeFromKnownDlls</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows NT\CurrentVersion\Windows\LoadAppInit_DLLs</TargetObject>
      ...
      <TargetObject condition="begin with">HKCU\SOFTWARE\Microsoft\Wbem\</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders\Startup</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders\Startup</TargetObject>
      <TargetObject condition="begin with">HKLM\SOFTWARE\WOW6432Node\Microsoft\Windows NT\CurrentVersion\SilentProcessExit</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows NT\CurrentVersion\SilentProcessExit</TargetObject>
      <TargetObject condition="begin with">HKLM\SOFTWARE\WOW6432Node\Microsoft\Active Setup\Installed Components</TargetObject>
      <TargetObject condition="begin with">HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\UIHost</TargetObject>
      <TargetObject condition="begin with">HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Shell Extensions\Approved</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\</TargetObject>
      ...
      <TargetObject condition="begin with">HKCR\lnkfile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Classes\Protocols\Handler\</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\RunOnceEx</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\RunOnceEx</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders\Startup</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Classes\ms-settings\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Classes\mscfile\shell\open\command</TargetObject>
      ...
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Active Setup\Installed Components</TargetObject>
      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\AppCertDlls</TargetObject>
      <TargetObject condition="contains all">HKCU\Software\Classes\CLSID;LocalServer32</TargetObject>
      <TargetObject condition="contains all">HKCR\CLSID;LocalServer32</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows NT\CurrentVersion\Winlogon\SpecialAccounts\UserList</TargetObject>
      ...
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\RunServices</TargetObject>
      ...
      <TargetObject condition="begin with">HKLM\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\App Paths\</TargetObject>
      ...
      <TargetObject condition="begin with">HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\App Paths\</TargetObject>
      <TargetObject condition="begin with">HKCR\*\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\Directory\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\Drive\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\batfile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\cmdfile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\jsfile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\vbsfile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCR\htafile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKLM\SOFTWARE\Microsoft\Command Processor\AutoRun</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Command Processor\AutoRun</TargetObject>
      ...
      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Control\SafeBoot\AlternateShell</TargetObject>
      ...
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\Run</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\Run</TargetObject>
      <TargetObject condition="begin with">HKCR\Protocols\Handler\</TargetObject>
      <TargetObject condition="contains all">HKLM\SOFTWARE\Classes\AppID;DllSurrogate</TargetObject>
      <TargetObject condition="contains all">HKCR\AppID;DllSurrogate</TargetObject>
      <TargetObject condition="begin with">HKCR\scrfile\shell\open\command</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Shell Extensions\Approved</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows NT\CurrentVersion\Winlogon\Notify</TargetObject>
      <TargetObject condition="begin with">HKCU\Environment\UserInitMprLogonScript</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\ShellServiceObjectDelayLoad</TargetObject>
      <TargetObject condition="begin with">HKLM\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Explorer\Shell Extensions\Approved</TargetObject>
      <TargetObject condition="begin with">HKCR\Protocols\Filter\</TargetObject>
      <TargetObject condition="begin with">HKCR\Protocols\ShellServiceObjects\</TargetObject>
      <TargetObject condition="begin with">HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\WMI\</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Classes\WMI\</TargetObject>
      <TargetObject condition="begin with">HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\KnownDLLs32</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\Run32</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\Run32</TargetObject>
      <TargetObject condition="begin with">HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\StartupFolder</TargetObject>
      <TargetObject condition="begin with">HKLM\Software\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\StartupFolder</TargetObject>
    </RegistryEvent>

    <RuleGroup groupRelation="or">
      <RegistryEvent onmatch="exclude">
        <TargetObject condition="is">HKLM\System\CurrentControlSet\Services\Tcpip\Parameters</TargetObject>
        <TargetObject condition="contains all">HKU\S-1-5-21-;SOFTWARE\Microsoft\Windows\CurrentVersion\Internet Settings</TargetObject>
        ...
        <Rule groupRelation="and">
          ...
          <TargetObject condition="begin with">HKLM\SOFTWARE\Microsoft\Multimedia\Audio\Journal\Render</TargetObject>
        </Rule>
      ...
      <ProcessCreate onmatch="include">
        ...
        <Rule name="technique_id=T1003,technique_name=Credential Dumping (Likely)" groupRelation="and">
          ...
          <CommandLine condition="contains">\s</CommandLine>
                ...
                <CommandLine condition="contains">NTLM</CommandLine>
                <CommandLine condition="contains">ncacn_np</CommandLine>
        </Rule>
        ...
        <Rule name="Scheduled Task/Job" groupRelation="or">
          <OriginalFileName name="technique_id=T1053.005,technique_name=Scheduled Task/Job" condition="contains">schtasks.exe</OriginalFileName>
                <OriginalFileName name="technique_id=T1053.005,technique_name=Scheduled Task/Job" condition="contains">sctasks.exe</OriginalFileName>
                <OriginalFileName name="technique=T1053.002,technique_name=At" condition="contains">at.exe</OriginalFileName>
                <OriginalFileName name="technique=T1053.002,technique_name=At" condition="contains">At.exe</OriginalFileName>
        ...
        <Rule name="File Permissions Modification" groupRelation="or">
          ...
          <OriginalFileName name="technique_id=T1222.001,technique_name=File Permissions Modification" condition="contains">icacls.exe</OriginalFileName>
                <OriginalFileName name="technique_id=T1222.001,technique_name=File Permissions Modification" condition="contains">cacls.exe</OriginalFileName>
                <OriginalFileName name="technique_id=T1222.001,technique_name=File Permissions Modification" condition="contains">xcacls.exe</OriginalFileName>
        </Rule>
        ...
        <Rule name="technique_id=T1490,technique_name=Inhibit System Recovery" groupRelation="and">
          <OriginalFileName condition="contains">vssadmin.exe</OriginalFileName>
        ...
        <Rule name="Account Discovery" groupRelation="or">
          ...
          <CommandLine name="technique_id=T1087.001,technique_name=Local Account" condition="contains">net localgroup</CommandLine>
                <CommandLine name="technique_id=T1087.001,technique_name=Local Account" condition="contains">net user</CommandLine>
                <CommandLine name="technique_id=T1087.001,technique_name=Local Account" condition="contains">net group</CommandLine>
                <CommandLine name="technique_id=T1087.001,technique_name=Local Account" condition="contains">dir C:\users</CommandLine>
                <CommandLine name="technique_id=T1087.001,technique_name=Local Account" condition="contains">ls C:\users</CommandLine>
                <CommandLine name="technique_id=T1087.001,technique_name=Local Account" condition="contains">dir C:\Users</CommandLine>
                <CommandLine name="technique_id=T1087.001,technique_name=Local Account" condition="contains">ls C:\Users</CommandLine>
        ...
        <Rule name="System Owner/User Discovery" groupRelation="or">
          <OriginalFileName name="technique_id=T1033,technique_name=System Owner/User Discovery" condition="contains">systeminfo.exe</OriginalFileName>
          <OriginalFileName name="technique_id=T1033,technique_name=System Owner/User Discovery" condition="contains">sysinfo.exe</OriginalFileName>
          ...
          <OriginalFileName name="technique_id=T1033,technique_name=System Owner/User Discovery" condition="contains">nltest.exe</OriginalFileName>
          <OriginalFileName name="technique_id=T1033,technique_name=System Owner/User Discovery" condition="contains">nltestk.exe</OriginalFileName>
        </Rule>
        ...
        <Rule name="System Network Configuration Discovery" groupRelation="or">
          ...
          <OriginalFileName name="technique_id=T1016,technique_name=System Network Configuration Discovery" condition="contains">nbtstat.exe</OriginalFileName>
          <OriginalFileName name="technique_id=T1016,technique_name=System Network Configuration Discovery" condition="contains">nbtinfo.exe</OriginalFileName>
        </Rule>
        ...
        <Rule name="Remote System Discovery" groupRelation="or">
          <OriginalFileName name="technique_id=T1018,technique_name=Remote System Discovery" condition="contains">net.exe</OriginalFileName>
          <OriginalFileName name="technique_id=T1018,technique_name=Remote System Discovery" condition="contains">net1.exe</OriginalFileName>
          <OriginalFileName name="technique_id=T1018,technique_name=Remote System Discovery" condition="contains">ping.exe</OriginalFileName>
          <OriginalFileName name="technique_id=T1018,technique_name=Remote System Discovery" condition="contains">dsquery.exe</OriginalFileName>
          <CommandLine name="technique_id=T1018,technique_name=Remote System Discovery" condition="contains">net view</CommandLine>
          <CommandLine name="technique_id=T1018,technique_name=Remote System Discovery" condition="contains">net group</CommandLine>
        </Rule>
        ...
        <Rule name="File and Directory Discovery" groupRelation="or">
          <OriginalFileName name="technique_id=T1083,technique_name=File and Directory Discovery" condition="contains">tree.com</OriginalFileName>
          <OriginalFileName name="technique_id=T1083,technique_name=File and Directory Discovery" condition="contains">findstr.exe</OriginalFileName>
          <OriginalFileName name="technique_id=T1083,technique_name=File and Directory Discovery" condition="contains">where.exe</OriginalFileName>
          <CommandLine name="technique_id=T1083,technique_name=File and Directory Discovery" condition="contains">ls</CommandLine>
          <CommandLine name="technique_id=T1083,technique_name=File and Directory Discovery" condition="contains">dir</CommandLine>
        </Rule>
        ...
        <Rule name="technique_id=T1112,technique_name=Modify Registry" groupRelation="and">
          ...
          <CommandLine condition="contains">.reg</CommandLine>
        </Rule>
        <Rule name="technique_id=T1112,technique_name=Modify Registry" groupRelation="and">
          <OriginalFileName condition="is any">reg.exe;regedit.exe</OriginalFileName>
          <CommandLine condition="contains">hklm</CommandLine>
          <CommandLine condition="contains">HKLM</CommandLine>
          <CommandLine condition="contains">hkey_local_machine</CommandLine>
    ...
    <RuleGroup groupRelation="or">
      <ProcessCreate onmatch="include">
        ...
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">SetWindowsHookEx</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">VirtualProtect</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">WriteProcessMemory</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">CreateRemoteThread</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtWriteVirtualMemory</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">ZwWriteVirtualMemory</CommandLine>
        

        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">DeviceIoControl</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtDeviceIoControlFile</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">ZwDeviceIoControlFile</CommandLine>
        

        <CommandLine name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains all">sc;stop;sysmon</CommandLine>
        <CommandLine name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains all">sc;delete;sysmon</CommandLine>
        <CommandLine name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains all">net;stop;sysmon</CommandLine>
        <CommandLine name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains all">taskkill;sysmon</CommandLine>
        <CommandLine name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains all">wevtutil;cl;Microsoft-Windows-Sysmon</CommandLine>
        <CommandLine name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains all">reg;delete;sysmon</CommandLine>
        

        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains all">ntdll;LdrGetProcedureAddress</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains all">ntdll;NtProtectVirtualMemory</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains all">kernel32;GetProcAddress</CommandLine>
        

        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">LoadLibrary</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">LdrLoadDll</CommandLine>
        <CommandLine name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">GetModuleHandle</CommandLine>

        <CommandLine name="technique_id=T1014,technique_name=Rootkit" condition="contains">KeServiceDescriptorTable</CommandLine>
        <CommandLine name="technique_id=T1014,technique_name=Rootkit" condition="contains">KiSystemCall64</CommandLine>
        <CommandLine name="technique_id=T1014,technique_name=Rootkit" condition="contains">KiFastSystemCall</CommandLine>
        <CommandLine name="technique_id=T1027,technique_name=Obfuscated Files or Information" condition="contains">../../</CommandLine>
        ...
        <Rule name="Type Bypass - OriginalFileName Mismatch" groupRelation="and">
          <OriginalFileName name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is">svchost.exe</OriginalFileName>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not begin with">C:\Windows\System32\svchost.exe</Image>
        </Rule>
        <Rule name="Type Bypass - OriginalFileName Mismatch" groupRelation="and">
          <OriginalFileName name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is">explorer.exe</OriginalFileName>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\explorer.exe</Image>
        </Rule>
        <Rule name="Type Bypass - OriginalFileName Mismatch" groupRelation="and">
          <OriginalFileName name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is">winlogon.exe</OriginalFileName>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\winlogon.exe</Image>
        </Rule>
        <Rule name="Type Bypass - OriginalFileName Mismatch" groupRelation="and">
          <OriginalFileName name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is">lsass.exe</OriginalFileName>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\lsass.exe</Image>
        </Rule>
        <Rule name="Type Bypass - OriginalFileName Mismatch" groupRelation="and">
          <OriginalFileName name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is">csrss.exe</OriginalFileName>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\csrss.exe</Image>
        </Rule>
        <Rule name="Type Bypass - OriginalFileName Mismatch" groupRelation="and">
          <OriginalFileName name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is">wininit.exe</OriginalFileName>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\wininit.exe</Image>
        </Rule>
        

        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">svch0st.exe;svchost32.exe;svchost64.exe;svchosts.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">lsas.exe;lsass32.exe;lsasss.exe;1sass.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">csrss32.exe;csrs.exe;cssrss.exe;crss.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">winl0gon.exe;winlogon32.exe;winlog0n.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">exp1orer.exe;explorer32.exe;explor3r.exe;iexplorer.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">taskmgr32.exe;taskmanager.exe;taskmanger.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">notepad32.exe;notepadd.exe;n0tepad.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">chrome32.exe;chromee.exe;chr0me.exe;googlechrome.exe</Image>
        <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is any">firefox32.exe;firefoxx.exe;firef0x.exe;mozillafirefox.exe</Image>
        

        <Rule name="Type Bypass - Double Extension" groupRelation="or">
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.pdf.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.doc.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.docx.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.xls.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.xlsx.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.ppt.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.pptx.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.txt.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.jpg.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.png.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.mp3.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.mp4.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.avi.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.zip.exe</Image>
          <Image name="technique_id=T1036.007,technique_name=Double File Extension" condition="end with">.rar.exe</Image>
        </Rule>
        

        <Rule name="Type Bypass - System Process Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">svchost.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not begin with">C:\Windows\System32\</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not begin with">C:\Windows\SysWOW64\</Image>
        </Rule>
        <Rule name="Type Bypass - System Process Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">lsass.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\lsass.exe</Image>
        </Rule>
        <Rule name="Type Bypass - System Process Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">csrss.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\csrss.exe</Image>
        </Rule>
        <Rule name="Type Bypass - System Process Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">winlogon.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\winlogon.exe</Image>
        </Rule>
        

        <Rule name="Type Bypass - Unicode Homograph" groupRelation="or">
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">ѕvchost</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">ехplorer</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">lѕass</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">сsrss</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">wіnlogon</Image>

          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">роwershell</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">сmd</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">nоtepad</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">tаskmgr</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">rеgedit</Image>

          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">ρowershell</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">εxplorer</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">νotepad</Image>
        </Rule>
        

        <Rule name="Type Bypass - Unicode Control Characters" groupRelation="or">

          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u200B</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u200C</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u200D</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u2060</Image>
          <Image name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\uFEFF</Image>
        ...
        <Rule name="Type Bypass - Unicode in CommandLine" groupRelation="or">

          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">роwershell</CommandLine>
          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">сmd</CommandLine>
          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">nеt</CommandLine>
          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">wmic</CommandLine>

          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u200B</CommandLine>
          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u200C</CommandLine>
          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u200D</CommandLine>
          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\u2060</CommandLine>
          <CommandLine name="technique_id=T1036.008,technique_name=Masquerade File Type" condition="contains">\uFEFF</CommandLine>
        ...
        <Rule name="DLL Hijacking - Suspicious DLL Loading" groupRelation="or">

          <CommandLine name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">rundll32.exe;version.dll</CommandLine>
          <CommandLine name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">rundll32.exe;dwmapi.dll</CommandLine>
          <CommandLine name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">rundll32.exe;uxtheme.dll</CommandLine>
          <CommandLine name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">rundll32.exe;winmm.dll</CommandLine>
          <CommandLine name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains all">rundll32.exe;wtsapi32.dll</CommandLine>

          <CommandLine name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">rundll32.exe;\AppData\</CommandLine>
          <CommandLine name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">rundll32.exe;\ProgramData\</CommandLine>
          <CommandLine name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">rundll32.exe;\Temp\</CommandLine>
          <CommandLine name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">rundll32.exe;\Public\</CommandLine>
          <CommandLine name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">rundll32.exe;\Downloads\</CommandLine>
        </Rule>
        

        <Rule name="DLL Hijacking - Process from Suspicious Location" groupRelation="and">
          <Image name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains any">\AppData\;\ProgramData\;\Temp\;\Public\;\Downloads\</Image>
          <ParentImage name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains any">explorer.exe;winrar.exe;7z.exe;chrome.exe;firefox.exe</ParentImage>
        </Rule>
        

        <Rule name="DLL Hijacking - Phantom DLL" groupRelation="or">

          <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="end with">\svchost.exe</Image>
          <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="not begin with">C:\Windows\System32\</Image>
          <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="not begin with">C:\Windows\SysWOW64\</Image>
        </Rule>
        

        <Rule name="Type Bypass - Suspicious Parent" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">svchost.exe</Image>
          <ParentImage name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\services.exe</ParentImage>
          <ParentImage name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\MsMpEng.exe</ParentImage>
          <ParentImage name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not end with">svchost.exe</ParentImage>
        </Rule>
        
 
        <Rule name="Type Bypass - Popular Apps Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">chrome.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not begin with">C:\Program Files\Google\Chrome\Application\</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not begin with">C:\Program Files (x86)\Google\Chrome\Application\</Image>
        </Rule>
        <Rule name="Type Bypass - Popular Apps Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">firefox.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not begin with">C:\Program Files\Mozilla Firefox\</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="not begin with">C:\Program Files (x86)\Mozilla Firefox\</Image>
        </Rule>
        <Rule name="Type Bypass - Popular Apps Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">notepad.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\notepad.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\SysWOW64\notepad.exe</Image>
        </Rule>
        <Rule name="Type Bypass - Popular Apps Wrong Location" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">taskmgr.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\System32\taskmgr.exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="is not">C:\Windows\SysWOW64\taskmgr.exe</Image>
        </Rule>
        

        <Rule name="Type Bypass - Fake svchost with suspicious args" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">svchost.exe</Image>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="excludes">-k</CommandLine>
        </Rule>
        <Rule name="Type Bypass - Fake explorer with args" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="end with">explorer.exe</Image>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains any">-c;/c;-e;/e;-r;/r;-d;/d</CommandLine>
        </Rule>
        

        <Rule name="Type Bypass - Spaces in Process Names" groupRelation="or">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">svchost .exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">explorer .exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">lsass .exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">csrss .exe</Image>
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">winlogon .exe</Image>
        </Rule>
        ...
        <Rule name="Type Command File Copy Bypass" groupRelation="and">
          <Image name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="image">cmd.exe</Image>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains all">type;></CommandLine>
        </Rule>
        
        <Rule name="Type Command Suspicious Redirection" groupRelation="and">
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">type "</CommandLine>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains"> > "</CommandLine>
        </Rule>
        
        <Rule name="Type Command with Executable Extensions" groupRelation="and">
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">type</CommandLine>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains any">.exe">.bat">.cmd">.scr">.com">.pif"</CommandLine>
        </Rule>
        
        <Rule name="Type Command from Suspicious Parent" groupRelation="and">
          <ParentImage name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains any">winrar.exe;7z.exe;7zg.exe;7zfm.exe</ParentImage>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains all">type;></CommandLine>
        </Rule>
        
        <Rule name="Type Command Copying System Files" groupRelation="and">
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains">type</CommandLine>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains any">\Windows\System32\;\Windows\SysWOW64\;\Program Files\;\Program Files (x86)\</CommandLine>
          <CommandLine name="technique_id=T1036.005,technique_name=Match Legitimate Name or Location" condition="contains"> > </CommandLine>
        </Rule>
      </ProcessCreate>
    </RuleGroup>
    ...
    <RuleGroup groupRelation="or">
      <FileCreateTime onmatch="include">
        ...
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - DLL Hijacking" condition="end with">.dll</TargetFilename>
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - System DLL" condition="contains all">.dll;\Windows\System32\</TargetFilename>
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - System DLL" condition="contains all">.dll;\Windows\SysWOW64\</TargetFilename>
        
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - DLL Hijacking" condition="end with">\version.dll</TargetFilename>
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - DLL Hijacking" condition="end with">\dwmapi.dll</TargetFilename>
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - DLL Hijacking" condition="end with">\amsi.dll</TargetFilename>
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - DLL Hijacking" condition="end with">\ntdll.dll</TargetFilename>
        <TargetFilename name="technique_id=T1070.006,technique_name=Timestomp - DLL Hijacking" condition="end with">\kernel32.dll</TargetFilename>
    ...
    <RuleGroup groupRelation="or">
      <NetworkConnect onmatch="include">
        ...
        <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="begin with">C:\Users\Public\</Image>
        <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="begin with">C:\ProgramData\</Image>
        <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains">\AppData\Local\Temp\</Image>
        <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains">\AppData\Roaming\</Image>
        <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains">\Downloads\</Image>
        <Image name="technique_id=T1574.001,technique_name=DLL Search Order Hijacking" condition="contains">\Documents\</Image>
        
        <Image name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">explorer.exe;\AppData\</Image>
        <Image name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">winrar.exe;\AppData\</Image>
        <Image name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">notepad.exe;\AppData\</Image>
        <Image name="technique_id=T1574.002,technique_name=DLL Side-Loading" condition="contains all">calc.exe;\AppData\</Image>
    ...
    <RuleGroup groupRelation="or">
      <ProcessTerminate onmatch="include">
        <Image condition="excludes">.</Image>
        <Image condition="not end with">\</Image>
      </ProcessTerminate>
      <ProcessTerminate onmatch="include">
        <Image condition="excludes">.</Image>
      </ProcessTerminate>
      <ProcessTerminate onmatch="include">
        <Image condition="end with">\\svchost</Image>
        <Image condition="end with">\\explorer</Image>
        <Image condition="end with">\\winlogon</Image>
        <Image condition="end with">\\lsass</Image>
        <Image condition="end with">\\csrss</Image>
        <Image condition="end with">\\chrome</Image>
        <Image condition="end with">\\firefox</Image>
        <Image condition="end with">\\notepad</Image>
        <Image condition="end with">\\calc</Image>
      ...
      <ProcessTerminate onmatch="include">
        <Image condition="contains">ѕvchost</Image>
      </ProcessTerminate>
      <ProcessTerminate onmatch="include">
        <Image condition="contains">ехplorer</Image>
      </ProcessTerminate>
      <ProcessTerminate onmatch="include">
        <Image condition="contains">lѕass</Image>
      </ProcessTerminate>
      <ProcessTerminate onmatch="include">
        <Image condition="contains">сsrss</Image>
      </ProcessTerminate>
      <ProcessTerminate onmatch="include">
        <Image condition="contains">wіnlogon</Image>
      </ProcessTerminate>
    </RuleGroup>

    <RuleGroup name="Process Terminate - Drives" groupRelation="or">
      <ProcessTerminate onmatch="include">
        ...
        <Image condition="begin with">G:\</Image>
        <Image condition="begin with">H:\</Image>
        <Image condition="begin with">I:\</Image>
        <Image condition="begin with">J:\</Image>
        <Image condition="begin with">K:\</Image>
        <Image condition="begin with">L:\</Image>
        <Image condition="begin with">M:\</Image>
        <Image condition="begin with">N:\</Image>
        <Image condition="begin with">O:\</Image>
        <Image condition="begin with">P:\</Image>
        <Image condition="begin with">Q:\</Image>
        <Image condition="begin with">R:\</Image>
        <Image condition="begin with">S:\</Image>
        <Image condition="begin with">T:\</Image>
        <Image condition="begin with">U:\</Image>
        <Image condition="begin with">V:\</Image>
        <Image condition="begin with">W:\</Image>
        <Image condition="begin with">X:\</Image>
        <Image condition="begin with">Y:\</Image>
        <Image condition="begin with">Z:\</Image>
    ...
    <RuleGroup name="Direct Memory Access Detection" groupRelation="or">
      <RawAccessRead onmatch="include">
        <Device condition="contains any">\Device\HarddiskVolume</Device>
      </RawAccessRead>
      
      <RawAccessRead onmatch="include">
        <Image condition="not begin with">C:\Windows\</Image>
        <Device condition="contains any">\Device\HarddiskVolume</Device>
      </RawAccessRead>
      
      <RawAccessRead onmatch="include">
        <Image condition="contains any">cheat;hack;inject;trainer;mod</Image>
        <Device condition="contains any">\Device\HarddiskVolume</Device>
      </RawAccessRead>
      
      <RawAccessRead onmatch="include">
        <Image condition="contains any">\\Temp\\;\\AppData\\;\\Downloads\\;\\Desktop\\</Image>
        <Device condition="contains any">\Device\HarddiskVolume</Device>
      </RawAccessRead>
      

      <RawAccessRead onmatch="include">
        <Image name="technique_id=T1006,technique_name=Direct Volume Access" condition="end with">HD-Player.exe</Image>
        <Device condition="contains any">\Device\HarddiskVolume;\Device\Floppy;\Device\CdRom</Device>
      </RawAccessRead>
      
      <RawAccessRead onmatch="include">
        <Image name="technique_id=T1140,technique_name=Deobfuscate/Decode Files or Information" condition="end with">HD-Player.exe</Image>
        <Device condition="contains any">\Device\PhysicalDrive</Device>
      </RawAccessRead>
    </RuleGroup>
    ...
    <RuleGroup groupRelation="or">
      <ProcessAccess onmatch="exclude">
        ...
        <Rule groupRelation="and">
          <SourceImage condition="is">C:\Program Files\NVIDIA Corporation\NvContainer\nvcontainer.exe</SourceImage>
        ...
        <Rule groupRelation="and">
          ...
          <TargetImage condition="end with">\Discord.exe</TargetImage>
          <GrantedAccess condition="is">0x1410</GrantedAccess>
        </Rule>
        <Rule groupRelation="and">
          <SourceImage condition="is">C:\Program Files\TaskBarX\TaskbarX.exe</SourceImage>
    ...
    <RuleGroup groupRelation="or">
      <RegistryEvent onmatch="include">
        ...
        <TargetObject name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">\software\microsoft\windows nt\currentversion\windows\appinit_dlls</TargetObject>
        <TargetObject name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">\software\wow6432node\microsoft\windows nt\currentversion\windows\appinit_dlls</TargetObject>
        <TargetObject name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">\software\microsoft\windows nt\currentversion\windows\loadappinit_dlls</TargetObject>
        
        <TargetObject name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">\software\microsoft\windows\currentversion\explorer\shellexecutehooks</TargetObject>
        <TargetObject name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">\software\microsoft\internet explorer\urlsearchhooks</TargetObject>
        <TargetObject name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">\software\wow6432node\microsoft\internet explorer\urlsearchhooks</TargetObject>
        
        <TargetObject name="technique_id=T1014,technique_name=Rootkit" condition="contains">\system\currentcontrolset\services\</TargetObject>
        <TargetObject name="technique_id=T1014,technique_name=Rootkit" condition="contains all">\system\currentcontrolset\control\session manager\;knowndlls</TargetObject>
        ...
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\system\currentcontrolset\services\sysmon64</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains all">\software\microsoft\windows\currentversion\winevt\channels\microsoft-windows-sysmon;enabled</TargetObject>
        

        <TargetObject name="technique_id=T1546.012,technique_name=Image File Execution Options Injection" condition="contains">\software\microsoft\windows nt\currentversion\image file execution options\</TargetObject>
        <TargetObject name="technique_id=T1546.012,technique_name=Image File Execution Options Injection" condition="contains">\software\wow6432node\microsoft\windows nt\currentversion\image file execution options\</TargetObject>
        

        <TargetObject name="technique_id=T1547.005,technique_name=Security Support Provider" condition="contains">\system\currentcontrolset\control\lsa\security packages</TargetObject>
        <TargetObject name="technique_id=T1547.005,technique_name=Security Support Provider" condition="contains">\system\currentcontrolset\control\lsa\oss packages</TargetObject>
        
        <TargetObject name="technique_id=T1546.003,technique_name=Windows Management Instrumentation Event Subscription" condition="contains">\software\classes\__eventfilter</TargetObject>
        <TargetObject name="technique_id=T1546.003,technique_name=Windows Management Instrumentation Event Subscription" condition="contains">\software\classes\__eventconsumer</TargetObject>
        <TargetObject name="technique_id=T1546.003,technique_name=Windows Management Instrumentation Event Subscription" condition="contains">\software\classes\__filtertoconsumerbinding</TargetObject>
    ...
    <RuleGroup name="Enhanced DNS Query Monitoring" groupRelation="or">
      <DnsQuery onmatch="include">
        <Rule name="Suspicious Domain Patterns" groupRelation="or">
          <QueryName condition="contains any">dga;malware;botnet;c2;command;control</QueryName>
        </Rule>
        <Rule name="Dynamic DNS Services" groupRelation="or">
        ...
        <Rule name="Suspicious TLDs" groupRelation="or">
        ...
        <Rule name="Base64 Encoded Domains" groupRelation="or">
          <QueryName condition="contains any">==;base64;encoded</QueryName>
        </Rule>
        <Rule name="Long Random Domains" groupRelation="or">
          <QueryName condition="more than">50</QueryName>
        </Rule>
        <Rule name="Tunneling Indicators" groupRelation="or">
          <QueryName condition="contains any">tunnel;dns2tcp;iodine;dnscat</QueryName>
        </Rule>
        <Rule name="Cryptocurrency Mining Pools" groupRelation="or">
          <QueryName condition="contains any">pool;mining;crypto;xmr;btc;eth</QueryName>
        </Rule>
        <Rule name="Tor and Proxy Services" groupRelation="or">
          <QueryName condition="contains any">tor;proxy;vpn;onion</QueryName>
        </Rule>
        <Rule name="Phishing Indicators" groupRelation="or">
          <QueryName condition="contains any">secure-;verify-;update-;login-;account-</QueryName>
        </Rule>
        <Rule name="Suspicious Subdomains" groupRelation="or">
          <QueryName condition="contains any">admin;panel;cpanel;webmail;ftp;mail;www2;dev;test;staging</QueryName>
        </Rule>
        <Rule name="IP Address Queries" groupRelation="or">
          <QueryName condition="contains">.</QueryName>
        </Rule>
        <Rule name="Hexadecimal Domains" groupRelation="or">
          <QueryName condition="contains">0</QueryName>
                <QueryName condition="contains">1</QueryName>
                <QueryName condition="contains">2</QueryName>
                <QueryName condition="contains">3</QueryName>
                <QueryName condition="contains">4</QueryName>
                <QueryName condition="contains">5</QueryName>
                <QueryName condition="contains">6</QueryName>
                <QueryName condition="contains">7</QueryName>
                <QueryName condition="contains">8</QueryName>
                <QueryName condition="contains">9</QueryName>
                <QueryName condition="contains">a</QueryName>
                <QueryName condition="contains">b</QueryName>
                <QueryName condition="contains">c</QueryName>
                <QueryName condition="contains">d</QueryName>
                <QueryName condition="contains">e</QueryName>
                <QueryName condition="contains">f</QueryName>
        </Rule>
        <Rule name="Fast Flux Indicators" groupRelation="or">
          <QueryName condition="contains any">fastflux;flux;rotating</QueryName>
        </Rule>
        <Rule name="Malware Family Indicators" groupRelation="or">
          <QueryName condition="contains any">emotet;trickbot;qakbot;cobalt;beacon</QueryName>
        </Rule>
        <Rule name="Suspicious Process DNS Queries" groupRelation="and">
          <Image condition="contains">powershell</Image>
          <QueryName condition="excludes">.microsoft.com</QueryName>
          <QueryName condition="excludes">.windows.com</QueryName>
          <QueryName condition="excludes">.office.com</QueryName>
        </Rule>
        <Rule name="Suspicious Process DNS Queries - CMD" groupRelation="and">
          <Image condition="contains">cmd</Image>
          <QueryName condition="excludes">.microsoft.com</QueryName>
          <QueryName condition="excludes">.windows.com</QueryName>
          <QueryName condition="excludes">.office.com</QueryName>
        </Rule>
        <Rule name="Suspicious Process DNS Queries - Scripts" groupRelation="and">
     ...
     <RuleGroup name="Comprehensive DNS Query Logging" groupRelation="or">
       <DnsQuery onmatch="include">
         <Rule name="All DNS Queries with Enhanced Logging" groupRelation="or">
    ...
    <RuleGroup groupRelation="or">
      ...
      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=AOB Substitution" condition="end with">HD-Player.exe</TargetImage>
      </CreateRemoteThread>
      
      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=AOB Substitution" condition="end with">HD-Player.exe</TargetImage>
        <StartModule condition="contains">kernel32.dll</StartModule>
      </CreateRemoteThread>
      
      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=AOB Substitution" condition="end with">HD-Player.exe</TargetImage>
        <StartModule condition="contains">ntdll.dll</StartModule>
      </CreateRemoteThread>
      

      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Cheat Injection" condition="end with">HD-Player.exe</TargetImage>
        <SourceImage condition="contains">inject</SourceImage>
      </CreateRemoteThread>
      
      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Cheat Injection" condition="end with">HD-Player.exe</TargetImage>
        <SourceImage condition="contains">cheat</SourceImage>
      </CreateRemoteThread>
      
      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Cheat Injection" condition="end with">HD-Player.exe</TargetImage>
        <SourceImage condition="contains">hack</SourceImage>
      </CreateRemoteThread>
      

      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Suspicious Location Injection" condition="end with">HD-Player.exe</TargetImage>
      ...
      <CreateRemoteThread onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Unsigned Injector" condition="end with">HD-Player.exe</TargetImage>
        <SourceImage condition="end with">.exe</SourceImage>
      </CreateRemoteThread>
    </RuleGroup>
    ...
    <RuleGroup name="Advanced Kernel Callback and SSDT Hook Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="SSDT Hook Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">SSDT;KeServiceDescriptorTable;KeServiceDescriptorTableShadow</CallTrace>
        </Rule>
        <Rule name="HAL Dispatch Table Manipulation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">HalDispatchTable;HalPrivateDispatchTable</CallTrace>
        </Rule>
        <Rule name="Kernel Callback Registration" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">PsSetCreateProcessNotifyRoutine;PsSetCreateThreadNotifyRoutine;PsSetLoadImageNotifyRoutine</CallTrace>
        </Rule>
        <Rule name="Object Manager Callbacks" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">ObRegisterCallbacks;ObUnRegisterCallbacks;PsSetCreateProcessNotifyRoutineEx</CallTrace>
        </Rule>
        <Rule name="Registry Callback Hooks" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">CmRegisterCallback;CmUnRegisterCallback;CmRegisterCallbackEx</CallTrace>
        </Rule>
        <Rule name="File System Filter Callbacks" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">FltRegisterFilter;FltUnregisterFilter;IoRegisterFsRegistrationChange</CallTrace>
        </Rule>
        <Rule name="Power State Callbacks" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">PoRegisterPowerSettingCallback;PoUnregisterPowerSettingCallback</CallTrace>
        </Rule>
        <Rule name="Shutdown Notification Callbacks" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">IoRegisterShutdownNotification;IoUnregisterShutdownNotification</CallTrace>
        </Rule>
        <Rule name="Bug Check Callbacks" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">KeRegisterBugCheckCallback;KeDeregisterBugCheckCallback;KeRegisterBugCheckReasonCallback</CallTrace>
        </Rule>
        <Rule name="Driver Verifier Callbacks" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">MmAddVerifierThunks;MmRemoveVerifierThunks</CallTrace>
        </Rule>
      </ProcessAccess>
      <RegistryEvent onmatch="include">
        <Rule name="Kernel Service Registration" groupRelation="or">
          <TargetObject condition="contains any">\\SYSTEM\\CurrentControlSet\\Services\\;\\Parameters\\ServiceDll</TargetObject>
          <Details condition="contains any">.sys;.dll</Details>
        </Rule>
        <Rule name="Driver Load Point Manipulation" groupRelation="or">
          <TargetObject condition="contains">\\SYSTEM\\CurrentControlSet\\Control\\SafeBoot\\Minimal</TargetObject>
        </Rule>
      </RegistryEvent>
      <FileCreate onmatch="include">
        <Rule name="Kernel Driver Creation" groupRelation="or">
          <TargetFilename condition="end with">.sys</TargetFilename>
          <Image condition="contains any">rootkit;hook;bypass</Image>
        </Rule>
      </FileCreate>
      <ProcessCreate onmatch="include">
        <Rule name="Kernel Debugging Tools" groupRelation="or">
          <CommandLine condition="contains any">kd.exe;windbg.exe;livekd.exe</CommandLine>
        </Rule>
        <Rule name="Driver Management Tools" groupRelation="or">
          <CommandLine condition="contains any">sc.exe create;net start;driverquery</CommandLine>
        </Rule>
      </ProcessCreate>
    </RuleGroup>

    <RuleGroup name="Hardware ID Tampering Detection" groupRelation="or">
      <RegistryEvent onmatch="include">
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\HARDWARE\\DESCRIPTION\\System\\CentralProcessor</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\HARDWARE\\DESCRIPTION\\System\\BIOS</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SYSTEM\\CurrentControlSet\\Enum\\PCI</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SYSTEM\\CurrentControlSet\\Control\\Class\\{4d36e968-e325-11ce-bfc1-08002be10318}</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SYSTEM\\CurrentControlSet\\Control\\SystemInformation</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\NetworkCards</TargetObject>
      </RegistryEvent>
    </RuleGroup>

    <RuleGroup name="Syscall Virtualization Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">KiSystemCall64</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">KiFastSystemCall</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">KiSystemService</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtSystemCallGate</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">syscall</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">sysenter</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Stealth Memory Mapping Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains all">NtMapViewOfSection;PAGE_EXECUTE_READWRITE</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains all">ZwMapViewOfSection;PAGE_EXECUTE_READWRITE</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">NtCreateSection</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">ZwCreateSection</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Device Serial Tampering Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">NtDeviceIoControlFile</CallTrace>
        <CallTrace name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">ZwDeviceIoControlFile</CallTrace>
        <CallTrace name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">DeviceIoControl</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      <FileCreate onmatch="include">
        <TargetFilename name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\Device\\</TargetFilename>
        <TargetFilename name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\DosDevices\\</TargetFilename>
      </FileCreate>
    </RuleGroup>

    <RuleGroup name="GPU Identifier Manipulation Detection" groupRelation="or">
      <RegistryEvent onmatch="include">
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SYSTEM\\CurrentControlSet\\Control\\Video</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SYSTEM\\CurrentControlSet\\Control\\Class\\{4d36e968-e325-11ce-bfc1-08002be10318}</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SOFTWARE\\Microsoft\\DirectX</TargetObject>
        <TargetObject name="technique_id=T1562.001,technique_name=Disable or Modify Tools" condition="contains">\\SOFTWARE\\Khronos\\OpenGL</TargetObject>
      </RegistryEvent>
    </RuleGroup>

    <RuleGroup name="Kernel Driver Integrity Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1014,technique_name=Rootkit" condition="contains">NtLoadDriver</CallTrace>
        <CallTrace name="technique_id=T1014,technique_name=Rootkit" condition="contains">ZwLoadDriver</CallTrace>
        <CallTrace name="technique_id=T1014,technique_name=Rootkit" condition="contains">NtUnloadDriver</CallTrace>
        <CallTrace name="technique_id=T1014,technique_name=Rootkit" condition="contains">ZwUnloadDriver</CallTrace>
        <CallTrace name="technique_id=T1014,technique_name=Rootkit" condition="contains">IoCreateDriver</CallTrace>
        <CallTrace name="technique_id=T1014,technique_name=Rootkit" condition="contains">IoDeleteDriver</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      <FileCreate onmatch="include">
        <TargetFilename name="technique_id=T1014,technique_name=Rootkit" condition="end with">.sys</TargetFilename>
      </FileCreate>
    </RuleGroup>

    <RuleGroup name="Manual DLL Mapping Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=Manual DLL Mapping" condition="contains all">NtAllocateVirtualMemory;NtWriteVirtualMemory;NtProtectVirtualMemory</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=Manual DLL Mapping" condition="contains all">ZwAllocateVirtualMemory;ZwWriteVirtualMemory;ZwProtectVirtualMemory</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=Manual DLL Mapping" condition="contains all">NtCreateSection;NtMapViewOfSection;RtlImageDirectoryEntryToData</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
  
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=Manual DLL Mapping" condition="contains all">LdrGetProcedureAddress;RtlImageDirectoryEntryToData;NtWriteVirtualMemory</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=Reflective DLL Loading" condition="contains all">VirtualAlloc;WriteProcessMemory;CreateRemoteThread</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
 
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=Memory Module Loading" condition="contains all">NtAllocateVirtualMemory;RtlImageNtHeader;LdrResolveDelayLoadedAPI</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Memory Remapping Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">MmMapIoSpace</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">MmUnmapIoSpace</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">MmMapLockedPages</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">MmUnmapLockedPages</CallTrace>
        <CallTrace name="technique_id=T1055.001,technique_name=API Hooking" condition="contains">MmGetPhysicalAddress</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Direct Syscall Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.012,technique_name=Direct System Calls" condition="is"></CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>


      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.012,technique_name=Direct System Calls" condition="excludes">ntdll.dll</CallTrace>
        <CallTrace condition="excludes">kernel32.dll</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
  
      <CreateRemoteThread onmatch="include">
        <StartAddress name="technique_id=T1055.012,technique_name=Direct System Calls" condition="not begin with">0x7</StartAddress>
        <StartAddress condition="excludes">.dll</StartAddress>
      </CreateRemoteThread>
      

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.012,technique_name=Manual Syscall Implementation" condition="contains any">mov eax;syscall;sysenter</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
    
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.012,technique_name=Heaven's Gate" condition="contains any">wow64cpu.dll;wow64.dll</CallTrace>
        <CallTrace condition="excludes">ntdll.dll</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Kernel-Mode Memory Access Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1014,technique_name=Kernel Driver Bypass" condition="end with">HD-Player.exe</TargetImage>
        <SourceImage condition="end with">.sys</SourceImage>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1014,technique_name=Unsigned Driver Load" condition="contains any">NtLoadDriver;ZwLoadDriver;IoCreateDriver</CallTrace>
      ...
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1014,technique_name=Kernel Object Manipulation" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">ObReferenceObjectByHandle;PsLookupProcessByProcessId;MmGetSystemRoutineAddress</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1014,technique_name=Physical Memory Access" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">MmMapIoSpace;MmGetPhysicalAddress;__readmsr;__writemsr</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Hardware Breakpoint Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Hardware Breakpoint Bypass" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">SetThreadContext;GetThreadContext;NtSetContextThread;NtGetContextThread</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Debug Register Manipulation" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">Dr0;Dr1;Dr2;Dr3;Dr6;Dr7</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Hardware Debug Bypass" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">DebugActiveProcess;DebugActiveProcessStop;WaitForDebugEvent</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Exception Handler Bypass" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">SetUnhandledExceptionFilter;AddVectoredExceptionHandler;RemoveVectoredExceptionHandler</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Memory-Mapped File Injection Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Memory Mapped File Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains all">CreateFileMapping;MapViewOfFile</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Section Object Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains all">NtCreateSection;NtMapViewOfSection;NtUnmapViewOfSection</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Transacted File Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">CreateTransaction;CreateFileTransacted;CommitTransaction;RollbackTransaction</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Pagefile Section Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">SEC_IMAGE;SEC_COMMIT;PAGE_EXECUTE_READWRITE</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Shared Memory Bypass Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Shared Memory Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">OpenFileMapping;CreateFileMapping</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Named Pipe Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">CreateNamedPipe;ConnectNamedPipe;WriteFile;ReadFile</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Process Doppelgänging Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.013,technique_name=Process Doppelgänging" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains all">NtCreateTransaction;NtCreateSection;NtRollbackTransaction</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Advanced Process Hollowing and Atom Bombing Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Classic Process Hollowing" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">NtUnmapViewOfSection;NtAllocateVirtualMemory;NtWriteVirtualMemory</CallTrace>
        </Rule>
        <Rule name="Advanced Process Hollowing" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">NtCreateSection;NtMapViewOfSection;NtUnmapViewOfSection</CallTrace>
        </Rule>
        <Rule name="Process Doppelgänging" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">NtCreateTransaction;NtCreateSection;NtRollbackTransaction</CallTrace>
        </Rule>
        <Rule name="Process Herpaderping" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">CreateFile;WriteFile;CreateProcess;SetFileInformation</CallTrace>
        </Rule>
        <Rule name="Atom Bombing Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">GlobalAddAtom;GlobalGetAtomName;SetWindowLong</CallTrace>
        </Rule>
        <Rule name="Advanced Atom Bombing" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">GlobalAddAtom;NtQueueApcThread;NtAlertResumeThread</CallTrace>
        </Rule>
        <Rule name="Ghost Writing" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">NtCreateSection;NtMapViewOfSection;NtWriteVirtualMemory;NtUnmapViewOfSection</CallTrace>
        </Rule>
      </ProcessAccess>
      <ProcessCreate onmatch="include">
        <Rule name="Suspended Process Creation" groupRelation="or">
          <CommandLine condition="contains any">CREATE_SUSPENDED;PROCESS_CREATE_PROCESS</CommandLine>
        </Rule>
        <Rule name="Transacted Process Creation" groupRelation="or">
          <CommandLine condition="contains any">NtCreateUserProcess;RtlCreateUserProcess</CommandLine>
        </Rule>
      </ProcessCreate>
      <ImageLoad onmatch="include">
        <Rule name="Hollowed Process Image Load" groupRelation="or">
    ...
    <RuleGroup name="Callback Injection Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=Callback Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">SetWindowsHookEx;SetWinEventHook;EnumWindows;EnumChildWindows</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1055.001,technique_name=APC Injection" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">QueueUserAPC;NtQueueApcThread;AlertResumeThread</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Advanced Evasion Detection" groupRelation="or">
 
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1562.006,technique_name=ETW Bypass" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">EtwEventWrite;EtwEventWriteTransfer;NtTraceEvent;EtwNotificationRegister</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1562.001,technique_name=AMSI Bypass" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">AmsiScanBuffer;AmsiScanString;AmsiInitialize;AmsiUninitialize</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1003.001,technique_name=LSASS Memory Dump" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">MiniDumpWriteDump;NtReadVirtualMemory;CreateToolhelp32Snapshot</CallTrace>
      ...
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1562.002,technique_name=API Unhooking" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">VirtualProtect;WriteProcessMemory;FlushInstructionCache;LdrLoadDll</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Firmware Level Attack Detection" groupRelation="or">
  
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1542.001,technique_name=UEFI Rootkit" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">NtSetSystemInformation;NtQuerySystemInformation;DeviceIoControl</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1542.001,technique_name=SMM Rootkit" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">__inbyte;__outbyte;__readmsr;__writemsr;IoPortRead;IoPortWrite</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="DMA Attack Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1006,technique_name=DMA Attack" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">HalAllocateCommonBuffer;MmAllocateContiguousMemory;IoAllocateMdl</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
    
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1006,technique_name=PCI Device Exploit" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">HalGetBusData;HalSetBusData;PciReadConfig;PciWriteConfig</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Speculative Execution Attack Detection" groupRelation="or">

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1211,technique_name=Speculative Execution" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">__cpuid;__rdtsc;__rdtscp;lfence;mfence;sfence</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1211,technique_name=Cache Timing Attack" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">clflush;prefetch;QueryPerformanceCounter;GetTickCount64</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Virtualization Escape Detection" groupRelation="or">
  
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1611,technique_name=VM Escape" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">vmcall;vmmcall;vmlaunch;vmresume;vmxon;vmxoff</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1611,technique_name=Hypervisor Exploit" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">HvCallFlushVirtualAddressSpace;HvCallFlushVirtualAddressList;HvCallSwitchVirtualAddressSpace</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
   
      <ProcessAccess onmatch="include">
        <TargetImage name="technique_id=T1611,technique_name=Container Escape" condition="end with">HD-Player.exe</TargetImage>
        <CallTrace condition="contains any">NtCreateUserProcess;NtCreateProcess;CreateProcessAsUser;CreateProcessWithToken</CallTrace>
        <SourceImage condition="contains any">docker;containerd;runc;podman</SourceImage>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="ROP/JOP Chain Detection" groupRelation="or">

      <CreateRemoteThread onmatch="include">
        <StartAddress name="technique_id=T1055.011,technique_name=ROP Chain Execution" condition="not begin with">0x7</StartAddress>
        <StartModule condition="is"></StartModule>
      </CreateRemoteThread>

      <CreateRemoteThread onmatch="include">
        <StartAddress name="technique_id=T1055.011,technique_name=JOP Chain Execution" condition="begin with">0x0</StartAddress>
        <StartAddress condition="excludes">.dll</StartAddress>
        <StartAddress condition="excludes">.exe</StartAddress>
      </CreateRemoteThread>
      

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.011,technique_name=ROP Gadget Preparation" condition="contains all">VirtualProtect;PAGE_EXECUTE_READ</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.002,technique_name=Shellcode Injection" condition="contains all">VirtualAlloc;WriteProcessMemory;CreateRemoteThread</CallTrace>
        <SourceImage condition="not begin with">C:\Windows\</SourceImage>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      
  
      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.011,technique_name=Advanced ROP Chain" condition="contains all">NtAllocateVirtualMemory;NtProtectVirtualMemory;NtCreateThreadEx</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
      

      <ProcessAccess onmatch="include">
        <CallTrace name="technique_id=T1055.011,technique_name=JOP Chain" condition="contains any">jmp;call</CallTrace>
        <CallTrace condition="excludes">ntdll.dll</CallTrace>
        <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Advanced Timing-Based Evasion Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Basic Timing Evasion" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">Sleep;WaitForSingleObject;GetTickCount;QueryPerformanceCounter</CallTrace>
        </Rule>
        <Rule name="Advanced Sleep Techniques" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">NtDelayExecution;ZwDelayExecution;SleepEx;WaitForSingleObjectEx</CallTrace>
        </Rule>
        <Rule name="Anti-Debug Timing" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">IsDebuggerPresent;CheckRemoteDebuggerPresent;NtQueryInformationProcess</CallTrace>
        </Rule>
        <Rule name="Performance Counter Evasion" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">QueryPerformanceFrequency;GetSystemTimeAsFileTime;NtQuerySystemTime</CallTrace>
        </Rule>
        <Rule name="Thread Timing Manipulation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">SuspendThread;Sleep;ResumeThread</CallTrace>
        </Rule>
        <Rule name="Conditional Timing Evasion" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">GetTickCount;Sleep;VirtualProtect</CallTrace>
        </Rule>
        <Rule name="Sandbox Timing Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">GetSystemMetrics;Sleep;GetCursorPos</CallTrace>
        </Rule>
      </ProcessAccess>
      <ProcessCreate onmatch="include">
        <Rule name="Delayed Process Execution" groupRelation="or">
          <CommandLine condition="contains any">timeout;ping -n;choice /t</CommandLine>
        </Rule>
      </ProcessCreate>
      <FileCreate onmatch="include">
        <Rule name="Timing-Based File Operations" groupRelation="or">
          <TargetFilename condition="contains">\\AppData\\Local\\Temp\\</TargetFilename>
          <Image condition="contains any">sleep;delay;wait</Image>
        </Rule>
      </FileCreate>
    </RuleGroup>

    <RuleGroup name="Advanced Hypervisor and Virtualization Attack Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Hypervisor Instructions" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">cpuid;vmcall;vmmcall;vmxon;vmxoff;vmlaunch;vmresume</CallTrace>
        </Rule>
        <Rule name="HVCI Bypass Attempts" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">NtSetSystemInformation;NtQuerySystemInformation;ZwSetSystemInformation</CallTrace>
        </Rule>
        <Rule name="Hypervisor Rootkit Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">cpuid;NtAllocateVirtualMemory;NtProtectVirtualMemory</CallTrace>
        </Rule>
        <Rule name="Blue Pill Attack Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">vmxon;vmcs;vmlaunch</CallTrace>
        </Rule>
        <Rule name="SLAT Manipulation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">invept;invvpid;vmfunc</CallTrace>
        </Rule>
      </ProcessAccess>
      <RegistryEvent onmatch="include">
        <Rule name="VM Detection Evasion" groupRelation="or">
          <TargetObject condition="contains any">\\SYSTEM\\CurrentControlSet\\Services\\VBoxService;\\SYSTEM\\CurrentControlSet\\Services\\VMTools;\\SYSTEM\\CurrentControlSet\\Services\\vmmouse</TargetObject>
        </Rule>
        <Rule name="Hypervisor Feature Manipulation" groupRelation="or">
          <TargetObject condition="contains any">\\SYSTEM\\CurrentControlSet\\Control\\DeviceGuard;\\SYSTEM\\CurrentControlSet\\Control\\CI\\Config</TargetObject>
        </Rule>
        <Rule name="HVCI Registry Tampering" groupRelation="or">
          <TargetObject condition="contains">\\SYSTEM\\CurrentControlSet\\Control\\CI\\HVCIOptions</TargetObject>
        </Rule>
      </RegistryEvent>
      <FileCreate onmatch="include">
        <Rule name="Hypervisor Bypass Tools" groupRelation="or">
          <TargetFilename condition="contains any">VBoxHook;VMwareHook;QemuHook;HyperHook</TargetFilename>
        </Rule>
        <Rule name="Virtualization Rootkit Files" groupRelation="or">
          <TargetFilename condition="contains any">.vmx;.vbox;.qcow2;.vhd;.vmdk</TargetFilename>
          <Image condition="contains any">hypervisor;rootkit;blue_pill</Image>
        </Rule>
      </FileCreate>
      <ProcessCreate onmatch="include">
        <Rule name="Hypervisor Management Tools" groupRelation="or">
          <CommandLine condition="contains any">VBoxManage;vmrun;qemu-system;Hyper-V</CommandLine>
        </Rule>
        <Rule name="VM Escape Attempts" groupRelation="or">
          <CommandLine condition="contains any">vmware-vmx;VirtualBox;qemu</CommandLine>
          <ParentImage condition="contains any">vmware;virtualbox;qemu</ParentImage>
        </Rule>
      </ProcessCreate>
    </RuleGroup>

 
    <RuleGroup name="Zero-Day Behavioral Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Memory Corruption Patterns" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">HeapAlloc;HeapReAlloc;HeapFree;RtlAllocateHeap;RtlReAllocateHeap;RtlFreeHeap</CallTrace>
        </Rule>
        <Rule name="Buffer Overflow Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">strcpy;strcat;sprintf;gets;memcpy;memmove;RtlCopyMemory</CallTrace>
        </Rule>
        <Rule name="Heap Spray Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">VirtualAlloc;VirtualAllocEx;HeapCreate;MapViewOfFile</CallTrace>
        </Rule>
        <Rule name="ROP Gadget Chains" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">pop;ret;jmp;call;leave;enter</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Exploit Mitigation Bypass Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="ASLR Bypass" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">GetModuleHandle;GetProcAddress;LoadLibrary;LdrLoadDll</CallTrace>
        </Rule>
        <Rule name="DEP Bypass" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">VirtualProtect;VirtualProtectEx;NtProtectVirtualMemory;SetProcessDEPPolicy</CallTrace>
        </Rule>
        <Rule name="CFG Bypass" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">SetProcessValidCallTargets;SetProcessDynamicEHContinuationTargets</CallTrace>
        </Rule>
        <Rule name="Stack Canary Bypass" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">__security_check_cookie;__report_gsfailure;__GSHandlerCheck</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Shellcode Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Injected Code Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">CreateRemoteThread;NtCreateThreadEx;RtlCreateUserThread;QueueUserAPC</CallTrace>
        </Rule>
        <Rule name="Executable Memory Allocation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">PAGE_EXECUTE;PAGE_EXECUTE_READ;PAGE_EXECUTE_READWRITE;PAGE_EXECUTE_WRITECOPY</CallTrace>
        </Rule>
        <Rule name="Dynamic Code Generation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">FlushInstructionCache;NtFlushInstructionCache;VirtualProtect</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Anomalous Process Behavior Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Rapid Memory Operations" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">VirtualAlloc;VirtualFree;HeapAlloc;HeapFree</CallTrace>
        </Rule>
        <Rule name="Suspicious API Sequences" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">OpenProcess;ReadProcessMemory;WriteProcessMemory;CloseHandle</CallTrace>
        </Rule>
        <Rule name="Exception Handler Manipulation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">SetUnhandledExceptionFilter;AddVectoredExceptionHandler;RtlAddVectoredExceptionHandler</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Advanced Multi-Stage Attack Correlation" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Reconnaissance Phase" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">GetSystemInfo;GetVersionEx;IsDebuggerPresent;CheckRemoteDebuggerPresent</CallTrace>
        </Rule>
        <Rule name="Environment Discovery" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">GetComputerName;GetUserName;GetCurrentDirectory;GetSystemDirectory</CallTrace>
        </Rule>
        <Rule name="Defense Evasion Preparation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">IsDebuggerPresent;Sleep;VirtualProtect</CallTrace>
        </Rule>
        <Rule name="Privilege Escalation Chain" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">AdjustTokenPrivileges;LookupPrivilegeValue;OpenProcessToken;SetTokenInformation</CallTrace>
        </Rule>
        <Rule name="Persistence Establishment" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">RegCreateKey;RegSetValue;CreateService;SetWindowsHookEx</CallTrace>
        </Rule>
        <Rule name="Lateral Movement Preparation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">NetUserEnum;NetShareEnum;WNetEnumResource;DsEnumerateDomainTrusts</CallTrace>
        </Rule>
        <Rule name="Credential Access Chain" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">OpenProcess;ReadProcessMemory;MiniDumpWriteDump</CallTrace>
        </Rule>
        <Rule name="Data Collection Phase" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">FindFirstFile;FindNextFile;GetFileAttributes;CryptEncrypt</CallTrace>
        </Rule>
        <Rule name="Command and Control Setup" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">InternetOpen;HttpOpenRequest;WinHttpConnect;WSAStartup</CallTrace>
        </Rule>
        <Rule name="Exfiltration Execution" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">CreateFile;ReadFile;InternetWriteFile</CallTrace>
        </Rule>
      </ProcessAccess>
      <ProcessCreate onmatch="include">
        <Rule name="Multi-Stage Process Chain" groupRelation="or">
          <ParentCommandLine condition="contains any">powershell;cmd;wscript;cscript</ParentCommandLine>
          <CommandLine condition="contains any">rundll32;regsvr32;mshta;certutil</CommandLine>
        </Rule>
        <Rule name="Living-off-the-Land Chain" groupRelation="or">
          <ParentImage condition="end with">\\explorer.exe</ParentImage>
          <CommandLine condition="contains any">powershell -enc;wmic process;schtasks /create</CommandLine>
        </Rule>
      </ProcessCreate>
      <NetworkConnect onmatch="include">
        <Rule name="C2 Communication Correlation" groupRelation="or">
          <Image condition="contains any">powershell;rundll32;regsvr32;mshta</Image>
          <DestinationPort condition="is any">80;443;8080;8443;53</DestinationPort>
        </Rule>
      </NetworkConnect>
      <FileCreate onmatch="include">
        <Rule name="Staged Payload Deployment" groupRelation="or">
          <TargetFilename condition="contains">\\AppData\\Local\\Temp\\</TargetFilename>
    ...
    <RuleGroup name="Thread Creation and Termination Detection" groupRelation="or">
      <CreateRemoteThread onmatch="include">
        <Rule name="Remote Thread Creation" groupRelation="or">
          <StartAddress condition="contains any">kernel32.dll;ntdll.dll;user32.dll</StartAddress>
        </Rule>
        <Rule name="Suspicious Thread Start Address" groupRelation="or">
          <StartAddress condition="excludes">.exe</StartAddress>
        </Rule>
        <Rule name="Thread Injection Detection" groupRelation="or">
          <StartFunction condition="contains any">LoadLibrary;LdrLoadDll;NtCreateThreadEx;RtlCreateUserThread</StartFunction>
        </Rule>
      </CreateRemoteThread>
    </RuleGroup>

    <RuleGroup name="Process Creation and Child Process Detection" groupRelation="or">
      <ProcessCreate onmatch="include">
        <Rule name="Suspicious Process Spawning" groupRelation="or">
          <CommandLine condition="contains any">cmd.exe;powershell.exe;rundll32.exe;regsvr32.exe</CommandLine>
        </Rule>
        <Rule name="Process Hollowing Detection" groupRelation="or">
          <Image condition="contains any">.tmp</Image>
          <CommandLine condition="contains any">CREATE_SUSPENDED;PROCESS_CREATE_PROCESS</CommandLine>
        </Rule>
      </ProcessCreate>
    </RuleGroup>

    <RuleGroup name="Window and GUI Injection Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Window Creation Monitoring" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">CreateWindow;CreateWindowEx;ShowWindow;SetWindowPos</CallTrace>
        </Rule>
        <Rule name="Window Destruction Monitoring" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">DestroyWindow;CloseWindow</CallTrace>
        </Rule>
        <Rule name="GUI Thread Injection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">AttachThreadInput;SetWindowsHookEx;CallNextHookEx</CallTrace>
        </Rule>
        <Rule name="Message Queue Manipulation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">PostMessage;SendMessage;PeekMessage;GetMessage</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Thread Hijacking and Context Manipulation" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Thread Context Manipulation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">SuspendThread;ResumeThread;GetThreadContext;SetThreadContext</CallTrace>
        </Rule>
        <Rule name="Thread Hijacking Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">OpenThread;TerminateThread;ExitThread;NtTerminateThread</CallTrace>
        </Rule>
        <Rule name="APC Queue Manipulation" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">QueueUserAPC;NtQueueApcThread;AlertResumeThread;TestAlert</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Fileless Malware and Living-off-the-Land Detection" groupRelation="or">
      <ProcessCreate onmatch="include">
        <Rule name="PowerShell Fileless Execution" groupRelation="or">
          <CommandLine condition="contains any">-EncodedCommand;-enc;-e;IEX;Invoke-Expression;DownloadString;DownloadData</CommandLine>
          <CommandLine condition="contains all">powershell;-WindowStyle Hidden;-ExecutionPolicy Bypass</CommandLine>
          <CommandLine condition="contains all">powershell;-NoProfile;-NonInteractive;-Command</CommandLine>
        </Rule>
        <Rule name="WMI Living-off-the-Land" groupRelation="or">
          <CommandLine condition="contains any">wmic process call create;wmic /node;wmic computersystem;wmic useraccount</CommandLine>
          <CommandLine condition="contains all">wmic;shadowcopy;delete</CommandLine>
        </Rule>
        <Rule name="WSCRIPT/CSCRIPT Fileless" groupRelation="or">
          <CommandLine condition="contains any">wscript //b;cscript //b;wscript //nologo;cscript //nologo</CommandLine>
          <CommandLine condition="contains all">wscript;http://;.vbs</CommandLine>
          <CommandLine condition="contains all">cscript;http://;.js</CommandLine>
        </Rule>
        <Rule name="MSBuild Living-off-the-Land" groupRelation="or">
          <CommandLine condition="contains any">msbuild.exe;MSBuild\\Current\\Bin</CommandLine>
          <Image condition="end with">\\MSBuild.exe</Image>
        </Rule>
        <Rule name="RegSvr32 Fileless" groupRelation="or">
          <CommandLine condition="contains any">regsvr32 /s /u /i:http;regsvr32 /s /n /u /i</CommandLine>
          <CommandLine condition="contains all">regsvr32;scrobj.dll</CommandLine>
        </Rule>
      </ProcessCreate>
      <ProcessAccess onmatch="include">
        <Rule name="In-Memory Payload Injection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">VirtualAllocEx;WriteProcessMemory;CreateRemoteThread</CallTrace>
        </Rule>
        <Rule name="Reflective Loading Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains all">LoadLibrary;GetProcAddress;VirtualProtect</CallTrace>
        </Rule>
        <Rule name="Memory-Only Execution" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="excludes all">CreateFile;WriteFile;SetFilePointer</CallTrace>
          <CallTrace condition="contains any">NtAllocateVirtualMemory;VirtualAlloc;HeapAlloc</CallTrace>
        </Rule>
      </ProcessAccess>
      <ImageLoad onmatch="include">
        <Rule name="Suspicious In-Memory Module Loading" groupRelation="or">
          <ImageLoaded condition="begin with">\\Device\\</ImageLoaded>
          <ImageLoaded condition="contains">\\AppData\\Local\\Temp\\</ImageLoaded>
          <Signature condition="is">Unsigned</Signature>
        </Rule>
      </ImageLoad>
      <NetworkConnect onmatch="include">
        <Rule name="Fileless C2 Communication" groupRelation="or">
          <Image condition="end with">\\powershell.exe</Image>
    ...
    <RuleGroup name="Stealth Detachment and Cleanup Detection" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Process Detachment" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">FreeLibrary;LdrUnloadDll;UnmapViewOfFile;VirtualFree</CallTrace>
        </Rule>
        <Rule name="Handle Cleanup Detection" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">CloseHandle;NtClose;DuplicateHandle;NtDuplicateObject</CallTrace>
        </Rule>
        <Rule name="Memory Cleanup" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">ZeroMemory;SecureZeroMemory;RtlSecureZeroMemory;memset</CallTrace>
        </Rule>
        <Rule name="Registry Cleanup" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">RegDeleteKey;RegDeleteValue;NtDeleteKey;NtDeleteValueKey</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Parent-Child Process Correlation" groupRelation="or">
      <ProcessAccess onmatch="include">
        <Rule name="Cross-Process Communication" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">CreatePipe;ConnectNamedPipe;CreateMailslot;CreateEvent</CallTrace>
        </Rule>
        <Rule name="Shared Memory Communication" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">CreateFileMapping;OpenFileMapping;MapViewOfFile;UnmapViewOfFile</CallTrace>
        </Rule>
        <Rule name="Process Synchronization" groupRelation="or">
          <GrantedAccess condition="is">0x1F0FFF</GrantedAccess>
          <CallTrace condition="contains any">CreateMutex;CreateSemaphore;WaitForSingleObject;WaitForMultipleObjects</CallTrace>
        </Rule>
      </ProcessAccess>
    </RuleGroup>

    <RuleGroup name="Process Creation - Other Drives" groupRelation="or">
      <ProcessCreate onmatch="include">
        <Image condition="begin with">D:\</Image>
        <Image condition="begin with">E:\</Image>
        <Image condition="begin with">F:\</Image>
